...
for 2016–2025 by the one-off `tools/fetch_forecast_extras.py` backfill (the Savant
...
Run:  python3 pipeline/fetch_coaches.py [season]      # season defaults to the current one
"""
