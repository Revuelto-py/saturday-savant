...
Usage:  python3 pipeline/fetch_passing.py                 # active season, all weeks
        python3 pipeline/fetch_passing.py --week 3        # one week
        python3 pipeline/fetch_passing.py --season 2025   # a specific season
