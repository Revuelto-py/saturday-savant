...
Follows the same conventions as pipeline/fetch_data.py (CFBD access_token config,
...
# launched from (a plain load_dotenv(_os.path.join(ROOT, '.env')) can miss it depending on where python
# is invoked).
...
# Only FBS home games, matching how pipeline/fetch_data.py scopes the 2025 season.
