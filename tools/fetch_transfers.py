...
Usage:  python3 tools/fetch_transfers.py              # portal 2021-2026 + derive era if missing
        python3 tools/fetch_transfers.py 2026         # specific portal year(s)
        python3 tools/fetch_transfers.py --derive     # force-rebuild the 2016-2020 derived era
"""
