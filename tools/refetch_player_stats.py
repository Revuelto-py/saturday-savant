...
Usage:  python3 tools/refetch_player_stats.py 2025
        python3 tools/refetch_player_stats.py 2016 2017 2018 2019 2020 2021 2022 2023 2024 2025
"""
...
for a in sys.argv[1:]:
    try:
        ...
        pass
if not years:
    print("usage: tools/refetch_player_stats.py <season> [season ...]")
    sys.exit(1)
