...
Usage:
    python3 backfill/backfill_rosters.py                 # all of 2016-2024
    python3 backfill/backfill_rosters.py 2019 2020       # specific seasons
...
Writes:
  • rosters — one row per (player, season): team/position/jersey/measurables.
    ...
    from the players snapshot in Phase 0 / owned by pipeline/fetch_2026_roster.py).
