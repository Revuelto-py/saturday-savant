...
Run:  python3 backfill/backfill_nfl.py            # both stages
      python3 backfill/backfill_nfl.py draft      # one stage
"""
...
def espn_nfl_teams():
    """id -> {name, logo}, same mapping tools/fetch_nfl_status.py uses."""
