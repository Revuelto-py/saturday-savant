...
frozen on write — pipeline/predict_games.py only ever touches the active season and only
...
Usage:  python3 backfill/backfill_2025_forecasts.py           # dry run: prints accuracy
        python3 backfill/backfill_2025_forecasts.py --write    # persist to game_predictions
"""
